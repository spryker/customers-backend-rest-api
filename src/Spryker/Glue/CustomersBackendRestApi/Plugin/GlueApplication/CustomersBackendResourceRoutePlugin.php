...
class CustomersBackendResourceRoutePlugin extends AbstractPlugin implements ResourceRoutePluginInterface
{
    /**
     * {@inheritDoc}
     * - Configures available actions for customers resource.
     *
     * @api
     *
    ...
    {
        return CustomersBackendRestApiConfig::RESOURCE_CUSTOMERS;
    }
    ...
    {
        return 'customers-backend-resource';
    }
